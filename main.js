...
passwordEl.setAttribute("placeholder", "Твой пароль");  
...
copyBtn.classList.add("password_button");
...
generateBtn.classList.add("password_button", "gen_but");
...
function generatePassword(passwordLength) { 
	...
	const lowerChars = "abcdifghijklmnopqrstuvwxyz";
	const symbolChars = "!@#$%^&*()_+";   
